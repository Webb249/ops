...
func ExampleExit() {
	opsviewplugin.Exit(plugin.CRITICAL, "Badness over 9000!")
}

func Example() {
	check := opsviewplugin.NewCheck()
	...
	check.AddResult(opsviewplugin.OK, "Everything looks shiny from here, cap'n")
